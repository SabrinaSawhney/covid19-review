...
<!--Perhaps we should change the title to: "Identification and Development of Therapeutics for COVID-19." We do have one section called "Prophylactic Administration of HCQ," which I think is OK to leave in as is, but to me, having "Prophylactics" in the title would imply that we're including vaccines.--> 
...
SARS-CoV-1 infection is severe, with an estimated death rate for SARS of 9.5% [@doi:10.1093/ajcp/aqaa029], while estimates of the death rate associated with COVID-19 are much lower, at approximately 2% [@individual-pathogenesis]. <!--Change here was to make it clearer that it was the CFR and not the IFR for the "death rate" - in other words, it's for people who have SARS/COVID-19, *not* for people infected with the viruses who may not show symptoms--> 
...
Current results suggest that pharmaceutical interventions for COVID-19 appear to be more successful than efforts to develop therapeutics for SARS and MERS were.
...
#### Overview of Therapeutic Approaches <!--Changed section title since we're not really discussing prophylactics--> 
...
On the other hand, therapeutics that directly target the virus itself would hold the potential to prevent people infected with SARS-CoV-2 from developing potentially damaging symptoms. <!--Not sure the previous 2 sentences are really in opposition to each other, to merit "on the other hand."--> 
...
A large number of clinical trials investigating a range of possible therapeutics for COVID-19 are currently in progress or have already been completed (Figure @fig:ebm-trials).
...
As we cover vaccines in a separate manuscript <!--cite it when available-->, we only consider therapies for the prevention of SARS-CoV-2 infection or COVID-19 in a very limited context here, for example when a drug is studied to see whether it can prevent infection or disease in recently-exposed individuals.
...
This process requires inhibiting the replication cycle of a virus by disrupting one of six fundamental steps [@isbn:978-1405136457]. <!--May want to reference Figure 3 here, though it has 9 separate steps (of course usually defining a “step” is usually a bit subjective)--> 
...
Despite the study reporting clinical improvement in favipiravir-treated patients, several study design issues are problematic and lower confidence in the overall conclusions <!--I'm not sure it's really fair to say that it's unclear if they would have recovered without treatment, as there was a comparison group. I'm also not sure about stating that more follow-up is necessary because of the sample size - if sample size is an issue, then a larger study should be done. Follow-up time doesn't increase the saple size.-->
For example, the study was neither randomized nor blinded. <!--I don't think it's actually bad that the control was another antiviral, it's better than nothing. If the difference is significant, it just means that drug A appears to work better than drug B.-->
...
The second study [@doi:10.1007/s00705-021-04956-9] was larger, with 96 patients enrolled, including only individuals with mild to moderate symptoms, randomized into two groups: one receiving chloroquine (CQ) in addition to SOC, and the other receiving favipiravir in addition to SOC. <!--It's specified at the beginning of the paragraph that all these are randomized, so edited to remove a bit of redundancy.-->
...
Remdesivir (GS-5734) is an intravenous antiviral that was developed by Gilead Sciences to treat Ebola Virus Disease (EVD). <!--Seems like it was developed against Hep-C and RSV, but wasn’t effective for them, then it was repurposed for Ebola eg https://www.nih.gov/news-events/nih-research-matters/final-report-confirms-remdesivir-benefits-covid-19 -->
...
Eight patients were excluded from the analysis mainly due to missing post-baseline information; thus, their health was unaccounted for. <!-- I took out the part about some patients getting worse and some dying, since these studies generally focus on average effects - some individuals can die and a drug could still work better than the alternative.-->
...
Therefore, the arguments put forward in defense of remdesivir do not necessarily seem robust in light of the large sample size used in the Solidarity trial, especially since the broad international nature of the Solidarity clinical trial, which included countries with a wide range of economic profiles and a variety of healthcare systems, provides a much-needed global perspective in a pandemic [@doi:10.1056/NEJMe2034294]. <!--This can be good and bad: For instance, the effect of remdesivir can be different in different countries, based on the way the SOC is applied (including general care conditions). Not sure if this is discussed in any of the papers.-->
...
In summary, remdesivir is a first in class drug due to its FDA approval. <!--It seems like “first in class” means it’s a novel mechanism. Not sure this is clear given the rest of the section-->
...
In comparison to the 14.1% rate of death in the no-HCQ cohort, these data indicated a statistically significant elevation in the risk of death for the HCQ-only group compared to the no-HCQ group (adjusted HR: 2.61, _p_ = 0.03), but not for the HCQ + AZ group compared to the no-HCQ group (adjusted HR: 1.14; _p_ = 0.72).
...
They include treatments such as humanized monoclonal antibodies (mAb), tocilizumab (TCZ), and neutralizing antibodies (nAbs), and can also include prophylactics such as vaccines. <!-- TODO: refer to vaccines standalone manuscript once it is available -->
...
Tocilizumab is being administered either as an intervention or as concomitant medication in {{ebm_tocilizumab_ct}} interventional COVID-19 clinical trials (Figure @fig:ebm-trials).
...
A second systematic review of studies investigating TCZ treatment for COVID-19 analyzed 31 studies that had been published or released as pre-prints and reported that none carried a low risk of bias [@doi:10.1016/j.pulmoe.2020.07.003].
...
In summary, approximately 25% of coronavirus patients develop ARDS, which is caused by an excessive early response of the immune system which can be a component of CRS [@doi:10.1016/j.chest.2020.06.006] and CSS [@doi:10.1186/s12967-020-02339-3].
...
For example, TLRs are pattern recognition receptors that recognize pathogen- and damage-associated molecular patterns and contribute to innate immune recognition and, more generally, promotion of both the innate and adaptive immune responses [@ISBN:9780815332183].
